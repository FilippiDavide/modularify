import {Anchor, Box, Center, Group, MediaQuery, Stack, Text} from "@mantine/core";
    ...
    return(
        <>
            ...
            <MediaQuery largerThan="sm" styles={{ display: 'none' }}>
                <Box>
                    <Center h='100%'>
                        <embed type="text/html" src="https://modularify.github.io/ProgressBars3D/" height="200px" width="100%"/>
                    </Center>
                    <Group position="right" mt={'1%'}>
                        <div>
                            <Stack spacing={0}>
